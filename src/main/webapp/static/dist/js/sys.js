var dtLanguage = {
              "emptyTable":     "当前无数据",
              "info":           "显示 _START_ 到 _END_ (共 _TOTAL_ 名)",
              "infoEmpty":      "当前无数据",
...
var bossLanguage = {
    "emptyTable":     "当前无数据",
    "info":           "显示 _START_ 到 _END_ (共 _TOTAL_ 个)",
    "infoEmpty":      "当前无数据",
    "infoFiltered":   "(从 _MAX_ 条数据中筛选得到)",
    "infoPostFix":    "",
    "thousands":      ",",
    "lengthMenu":     "显示 _MENU_ 个BOSS",
    "loadingRecords": "正在载入数据...",
    "processing":     "<img src='../../../image/datetable_loading.gif'>",
    "search":         "搜索:",
    "zeroRecords":    "未找到匹配的结果",
