...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>公会后台管理</title>
    <script src="${realPath}/js/jQuery/jQuery-2.1.4.min.js"></script>
    <script src="${realPath}/js/layer-v3.1.0/layer/layer.js"></script>
...
<script type="text/javascript">
    ...
    function login() {
        ...
        $.ajax({
            url: "${realPath}/user/login?name=" + name + "&&password=" + password,
            dataType: "json",
            type: "get",
...
<script src="${realPath}/static/StarrySky/js/TweenLite.min.js"></script>
<script src="${realPath}/static/StarrySky/js/EasePack.min.js"></script>
<script src="${realPath}/static/StarrySky/js/rAF.js"></script>
<script src="${realPath}/static/StarrySky/js/demo-1.js"></script>
