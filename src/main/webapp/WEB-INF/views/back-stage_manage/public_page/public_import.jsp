...
<script src="${path}/static/treeview/lib/jquery.cookie.js" type="text/javascript"></script>
<script src="${path}/static/treeview/lib/jquery.treeview.js" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="${path}/static/treeview/jquery.treeview.css">
<!-- 富文本 -->
